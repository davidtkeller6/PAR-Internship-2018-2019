    ...
    // Tilt compensated magnetic sensor measurements
      ...
      /*
      Serial.print(MAG_Data0); Serial.print("  ");
      Serial.print(MAG_Data1); Serial.print("  ");
      Serial.print(MAG_Data2); Serial.print("  ");
      Serial.print(MAG_Data3); Serial.print("  ");
      Serial.print(MAG_Data4); Serial.print("  ");
      Serial.print(MAG_Data5); Serial.println("  ");
      */
      delay(100);
